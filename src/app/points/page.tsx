  ...
  return (
    <div className="h-screen w-full flex flex-col justify-between">
      ...
      >
        ...
        {data?.length === 0 && <h1>Buy your first shouf points</h1>}
      ...
      <div
        className={` md:mx-24 p-8 mb-32 transition-all duration-300 rounded-2xl animate-gradient-x bg-gradient-to-r from-pink-600 via-blue-400 to-blue-900 bg-size-200 ${bgSize}`}
      >
